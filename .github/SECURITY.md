...
This is a public repository for setting up a Dynatrace → AAP Event-Driven Ansible integration. It contains **patterns, docs, and rulebook scaffolding only** — no live credentials, tokens, or tenant-specific values.
